...
})(
  {
      ...
      function (e, t, r) {
        (function (r, n) {
          ...
          function E(e) {
            ...
            (t.needReadable = !1),
              t.emittedReadable || (h('emitReadable', t.flowing), (t.emittedReadable = !0), t.sync ? i(M, e) : M(e));
          }
          function M(e) {
          ...
          function O(e) {
            ...
            t.endEmitted || ((t.ended = !0), i(T, t, e));
          }
          function T(e, t) {
          ...
          (w.prototype.read = function (e) {
            ...
            if (
              ...
              return h('read: emitReadable', t.length, t.ended), 0 === t.length && t.ended ? O(this) : E(this), null;
            ...
            return (
              ...
              t.ended || t.reading
                ...
                : i &&
                  ...
                  (t.sync = !1),
                  t.reading || (e = S(r, t))),
              null === (n = e > 0 ? P(e, t) : null) ? ((t.needReadable = !0), (e = 0)) : (t.length -= e),
            ...
            (w.prototype.pipe = function (e, t) {
              ...
              var d = (function (e) {
                return function () {
                  ...
                  h('pipeOnDrain', t.awaitDrain),
                    ...
                    0 === t.awaitDrain && a(e, 'data') && ((t.flowing = !0), C(e));
                };
              })(n);
              e.on('drain', d);
              var f = !1;
              ...
              function g(t) {
                h('ondata'),
                  ...
                  !1 !== e.write(t) ||
                    p ||
                    (((1 === o.pipesCount && o.pipes === e) || (o.pipesCount > 1 && -1 !== A(o.pipes, e))) &&
                      !f &&
            ...
            (w.prototype.on = function (e, t) {
              ...
              if ('data' === e) !1 !== this._readableState.flowing && this.resume();
                ...
                n.endEmitted ||
                  ...
                  (n.emittedReadable = !1),
                  n.reading ? n.length && E(this) : i(R, this));
              }
              return r;
            }),
            ...
            (w.prototype.resume = function () {
              ...
              return (
                e.flowing ||
                  ...
                  (e.flowing = !0),
                  (function (e, t) {
                    t.resumeScheduled || ((t.resumeScheduled = !0), i(j, e, t));
                  })(this, e)),
                this
              );
            }),
    ...
    23: [
      function (e, t, r) {
        ...
        class p extends u.default {
          constructor(
            e,
            { jsonRpcStreamName: t = 'metamask-provider', logger: r = console, maxEventListeners: n = 100 } = {}
          ) {
            if ((super(), !d.duplex(e))) throw new Error(f.default.errors.invalidDuplexStream());
            (this._log = r),
            ...
            l.push(o.createIdRemapMiddleware()),
              ...
              this._jsonRpcConnection.events.on('notification', (t) => {
                ...
                'metamask_accountsChanged' === r
                  ...
                  : 'METAMASK_STREAM_FAILURE' === r && e.destroy(new Error(f.default.errors.permanentlyDisconnected()));
              });
          }
          isConnected() {
          ...
          async request(e) {
            if (!e || 'object' != typeof e || Array.isArray(e))
              throw c.ethErrors.rpc.invalidRequest({ message: f.default.errors.invalidRequestArgs(), data: e });
            const { method: t, params: r } = e;
            if ('string' != typeof t || 0 === t.length)
              throw c.ethErrors.rpc.invalidRequest({ message: f.default.errors.invalidRequestMethod(), data: e });
            if (void 0 !== r && !Array.isArray(r) && ('object' != typeof r || null === r))
              throw c.ethErrors.rpc.invalidRequest({ message: f.default.errors.invalidRequestParams(), data: e });
          ...
          _handleDisconnect(e, t) {
            if (this._state.isConnected || (!this._state.isPermanentlyDisconnected && !e)) {
              ...
              (this._state.isConnected = !1),
                e
                  ? ((r = new c.EthereumRpcError(1013, t || f.default.errors.disconnected())), this._log.debug(r))
                  : ((r = new c.EthereumRpcError(1011, t || f.default.errors.permanentlyDisconnected())),
                    this._log.error(r),
                    (this.chainId = null),
          ...
          _handleStreamDisconnect(e, t) {
            h.logStreamDisconnectWarning(this._log, e, t, this), this._handleDisconnect(!1, t ? t.message : void 0);
          }
            ...
            e && 'string' == typeof e && e.startsWith('0x') && t && 'string' == typeof t
              ? 'loading' === t
                ...
                : (this._handleConnect(e),
                  e !== this.chainId &&
                    ((this.chainId = e), this._state.initialized && this.emit('chainChanged', this.chainId)))
      ...
      function (e, t, r) {
        ...
        class l extends u.default {
          constructor(
            ...
            if (
              ...
              if ('complete' === document.readyState) o.default(this._rpcEngine, this._log);
                ...
                const e = () => {
                  o.default(this._rpcEngine, this._log), window.removeEventListener('DOMContentLoaded', e);
                };
          ...
          _warnOfDeprecation(e) {
            var t;
            !1 === (null === (t = this._sentWarnings) || void 0 === t ? void 0 : t.events[e]) &&
              (this._log.warn(s.default.warnings.events[e]), (this._sentWarnings.events[e] = !0));
          }
          enable() {
            return (
              this._sentWarnings.enable ||
                (this._log.warn(s.default.warnings.enableDeprecation), (this._sentWarnings.enable = !0)),
              new Promise((e, t) => {
                try {
          ...
          send(e, t) {
            return (
              this._sentWarnings.send ||
                (this._log.warn(s.default.warnings.sendDeprecation), (this._sentWarnings.send = !0)),
    ...
    25: [
      function (e, t, r) {
        ...
        (r.initializeProvider = function ({
          ...
          let c = new i.default(e, { jsonRpcStreamName: t, logger: r, maxEventListeners: n, shouldSendMetadata: a });
          return (c = new Proxy(c, { deleteProperty: () => !0 })), u && s(c), l && o.default(c, r), c;
        }),
        ...
        Object.defineProperty(r, '__esModule', { value: !0 }),
          (r.default = function (e, t = console) {
            ...
            if (!window.web3) {
              ...
              Object.defineProperty(o, i, { value: !0, enumerable: !0, configurable: !1, writable: !1 }),
                (o = new Proxy(o, {
                  get: (o, s, ...a) => (
                    'currentProvider' !== s || r
                      ? 'currentProvider' === s ||
    ...
    31: [
      function (e, t, r) {
        ...
        (n.writable = (e) =>
          n(e) && !1 !== e.writable && 'function' == typeof e._write && 'object' == typeof e._writableState),
          (n.readable = (e) =>
            n(e) && !1 !== e.readable && 'function' == typeof e._read && 'object' == typeof e._readableState),
          (n.duplex = (e) => n.writable(e) && n.readable(e)),
          (n.transform = (e) =>
            n.duplex(e) && 'function' == typeof e._transform && 'object' == typeof e._transformState),
          (t.exports = n);
      },
      {},
    ],
      ...
      function (e, t, r) {
        ...
        function a(e, t, r) {
          ...
          var i = (function (e) {
            ...
            if (void 0 !== e.length) return 'number' != typeof e.length || U(e.length) ? o(0) : c(e);
        ...
        (r.kMaxLength = 2147483647),
          ...
          (s.prototype.compare = function (e, t, r, n, i) {
            if ((D(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), !s.isBuffer(e)))
              throw new TypeError(
        ...
        (s.prototype.slice = function (e, t) {
          ...
          (s.prototype.writeUInt16LE = function (e, t, r) {
            return (
              (e = +e), (t >>>= 0), r || P(this, e, t, 2, 65535, 0), (this[t] = 255 & e), (this[t + 1] = e >>> 8), t + 2
            );
          }),
          (s.prototype.writeUInt16BE = function (e, t, r) {
            return (
              (e = +e), (t >>>= 0), r || P(this, e, t, 2, 65535, 0), (this[t] = e >>> 8), (this[t + 1] = 255 & e), t + 2
            );
          }),
          ...
          var n = e('once'),
            ...
            o = function (e, t, s) {
              ...
              var a = e._writableState,
                ...
                y = function () {
                  if (!d)
                    return (!l || (u && u.ended && !u.destroyed)) && (!c || (a && a.ended && !a.destroyed))
                      ? void 0
              ...
              return (
                !(function (e) {
                  ...
                  : (e.on('complete', h), e.on('abort', b), e.req ? w() : e.on('request', w)),
                (function (e) {
        ...
        function o(e, t, r) {
          ...
          for (
            !(function e(t, r, o, s) {
                ...
                for (a = 0; a < o.length; a++)
                  if (o[a] === t) {
                    ...
                    return void (void 0 !== u.get
                      ? u.configurable
                        ? (Object.defineProperty(s, r, { value: '[Circular]' }), n.push([s, r, t, u]))
                        : i.push([t, r])
                      : ((s[r] = '[Circular]'), n.push([s, r, t])));
                  }
              ...
              o = 0 === i.length ? JSON.stringify(e, t, r) : JSON.stringify(e, u(t), r);
            0 !== n.length;
                  ...
                  for (u = 0; u < o.length; u++)
                    if (o[u] === t) {
                      ...
                      return void (void 0 !== l.get
                        ? l.configurable
                          ? (Object.defineProperty(a, r, { value: '[Circular]' }), n.push([a, r, t, l]))
                          : i.push([t, r])
                        : ((a[r] = '[Circular]'), n.push([a, r, t])));
                    }
                  if ('function' == typeof t.toJSON) return;
                  if ((o.push(t), Array.isArray(t))) for (u = 0; u < t.length; u++) e(t[u], u, o, t);
                  else {
                    var c = {},
                      d = Object.keys(t).sort(s);
        ...
        !(function (e, r) {
          ...
          function n(t) {
            return (
              'debug' === t && (t = 'log'),
              'undefined' != typeof console &&
                (void 0 !== console[t] ? r(console, t) : void 0 !== console.log ? r(console, 'log') : e)
            );
          }
          function i(r, n) {
          ...
          function a(e, r, n) {
            ...
            var c = l();
            null == c && (c = null == r ? 'WARN' : r), a.setLevel(c, !1);
          }
          var u = new a(),
            l = {};
          u.getLogger = function (e) {
            ...
            var t = l[e];
            return t || (t = l[e] = new a(e, u.getLevel(), u.methodFactory)), t;
          };
      ...
      function (e, t, r) {
        (function (r, n) {
          ...
          function E(e) {
            ...
            (t.needReadable = !1),
              t.emittedReadable ||
                (h('emitReadable', t.flowing), (t.emittedReadable = !0), t.sync ? i.nextTick(M, e) : M(e));
          }
          function M(e) {
            h('emit readable'), e.emit('readable'), C(e);
          }
            ...
            if (e._writev && r && r.next) {
              ...
              for (; r; ) {
                var l = r.chunk,
                  ...
                  d = r.callback;
                if (
                  (w(e, t, !1, t.objectMode ? 1 : l.length, l, c, d), (r = r.next), t.bufferedRequestCount--, t.writing)
                )
                  break;
              }
              null === r && (t.lastBufferedRequest = null);
